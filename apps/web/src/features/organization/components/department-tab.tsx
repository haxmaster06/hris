...
export default function DepartmentTab() {
  ...
  const entityName = t("modules.organization.departments");
          ...
          <table className="w-full text-left text-sm">
            <thead className="bg-zinc-50 dark:bg-zinc-900/50 text-zinc-600 dark:text-zinc-400 font-medium border-b border-zinc-200 dark:border-zinc-900 select-none">
              <tr>
                ...
                <th className="px-6 py-3 hidden md:table-cell">{t("modules.organization.branches")}</th>
                <th className="px-6 py-3 hidden md:table-cell">{t("common.parent") + " " + entityName}</th>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
          <div className="w-full max-w-lg bg-white dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-900 rounded-2xl p-6 shadow-2xl space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                <p className="text-[10px] uppercase font-bold text-zinc-400">{t("modules.organization.branches")}</p>
                <p className="text-sm font-semibold text-zinc-800 dark:text-zinc-200">{selectedDept.branch?.name || "-"}</p>
              </div>
              <div>
                <p className="text-[10px] uppercase font-bold text-zinc-400">{t("common.parent") + " " + entityName}</p>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
          ...
          >
            ...
            <div className="space-y-4">
              ...
              <div>
                <label className="block text-xs font-semibold text-zinc-700 dark:text-zinc-300 mb-1">{t("common.parent") + " " + entityName}</label>
                <select
            ...
            <div className="flex justify-end gap-3 pt-4 border-t border-zinc-100 dark:border-zinc-900">
              ...
              >
                ...
                {selectedDept ? t("common.save") : t("common.create")}
              </button>
            </div>
          </form>
        </div>
