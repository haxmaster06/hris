      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white dark:bg-zinc-950 p-4 border border-zinc-200 dark:border-zinc-900 rounded-xl">
        <div className="flex flex-1 gap-3 max-w-2xl">
          ...
          <select
            ...
            className="px-3 py-2 border border-zinc-200 dark:border-zinc-800 rounded-lg bg-zinc-50 dark:bg-zinc-900 text-sm text-zinc-750 focus:outline-none"
          >
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
          <div className="w-full max-w-lg bg-white dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-900 rounded-2xl p-6 shadow-2xl space-y-6">
            <div className="flex justify-between items-center pb-4 border-b border-zinc-100 dark:border-zinc-900">
              <h3 className="text-lg font-bold text-zinc-950 dark:text-zinc-50">Position Detail (Infolist)</h3>
              <button onClick={closeModal} className="text-zinc-400 hover:text-zinc-600">&times;</button>
            </div>
            
            <div className="grid grid-cols-2 gap-4">
              <div>
                <p className="text-[10px] uppercase font-bold text-zinc-400">Position Code</p>
                <p className="text-sm font-semibold text-zinc-800 dark:text-zinc-200">{selectedPos.code}</p>
              </div>
              <div>
                <p className="text-[10px] uppercase font-bold text-zinc-400">Position Name</p>
              ...
              <div className="col-span-2">
                ...
                <p className="text-sm text-zinc-600 dark:text-zinc-400">{selectedPos.job_description || "-"}</p>
              </div>
            </div>
          ...
          >
            <div className="flex justify-between items-center pb-4 border-b border-zinc-100 dark:border-zinc-900">
              <h3 className="text-lg font-bold text-zinc-950 dark:text-zinc-50">
                {selectedPos ? "Edit Position" : "Add New Position"}
              </h3>
            ...
            <div className="space-y-4">
              ...
              <div>
                <label className="block text-xs font-semibold text-zinc-700 dark:text-zinc-300 mb-1">Position Code</label>
                <input
                  type="text"
                  required
                  value={formData.code}
              ...
              <div>
                <label className="block text-xs font-semibold text-zinc-700 dark:text-zinc-300 mb-1">Position Name</label>
                <input
                  type="text"
                  required
                  value={formData.name}
            ...
            <div className="flex justify-end gap-3 pt-4 border-t border-zinc-100 dark:border-zinc-900">
              ...
              >
                ...
                {selectedPos ? "Update Position" : "Create Position"}
              </button>
            </div>
          </form>
        </div>
